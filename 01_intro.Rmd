...
kommrep_loc_lm <- kommrep_loc %>%
  ...
  rowwise() %>% 
  mutate(`kommunikative Inzivilität` = any(c_across(v_perzb_art1:v_perzb_art3), na.rm = TRUE)) %>% 
  mutate(`physische Inzivilität` = any(c_across(v_perzb_art4:v_perzb_art5), na.rm = TRUE)) %>% 
  ungroup() %>% 
